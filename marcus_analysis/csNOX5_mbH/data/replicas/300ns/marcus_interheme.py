...
file_st1_e1="nrj_st1_e1_21_26.dat"   # Files containing the energies of state 1 for MD performed on state 1
file_st1_e2="nrj_st1_e2_21_26.dat"   # Files containing the energies of state 2 for MD performed on state 1
file_st2_e1="nrj_st2_e1_21_26.dat"   # Files containing the energies of state 1 for MD performed on state 2
file_st2_e2="nrj_st2_e2_21_26.dat"   # Files containing the energies of state 2 for MD performed on state 2
...
try:
    with open(f'deltaG_csNOX5_mbH_A_{xmin}-{xmax2}.pkl', 'rb') as fichier:
...
with open(f'deltaG_csNOX5_mbH_A_{xmin}-{xmax2}.pkl', 'wb') as fichier:
